...
Route::middleware([
    ...
    Route::controller(App\Http\Controllers\ActivityController::class)->group(function(){
        Route::get('/activity','index')->name('activity.ViewActivityInterface');
...
// });
    ...
    Route::get('/calendar', [CalendarController::class, 'index'])->name('calendars');

    Route::get('/report/{id}/export-pdf', [ReportController::class, 'exportPdf'])->name('exportPdf');