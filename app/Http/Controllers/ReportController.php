...
class ReportController extends Controller
{
    ...
    public function exportPdf($id){
        $data = ReportRecord::findOrFail($id);
        $pdf = PDF::loadView('ManageReport.report-list',compact('data'));
        return $pdf->stream('ManageReport.report-list.pdf');
        //return view ('ManageReport.report-list', compact('data'));
    }
}
