                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label text-right">Interest</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="interest">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label text-right">CGPA</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="candidate_faculty" value="FKOM">
                                            </div>
                                            </div>
                                        </div>
